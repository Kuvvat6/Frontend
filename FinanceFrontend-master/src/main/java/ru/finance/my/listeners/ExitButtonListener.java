...
public class ExitButtonListener implements ComponentEventListener<ClickEvent<Button>> {

  private final RestTemplate restTemplate;

  public ExitButtonListener(RestTemplate restTemplate) {
  ...
  public void onComponentEvent(ClickEvent<Button> buttonClickEvent) {
    try {
      ...
      String url = AppConfiguration.SERVER_HOST + "/logouts";
